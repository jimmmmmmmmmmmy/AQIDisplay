...
class SearchCityWindow(NSObject):
    ...
    def setupUI(self):
        ...
        # Location input
        self.location_input = NSTextField.alloc().initWithFrame_(
            NSMakeRect(20, 260, 260, 24)
        )
        ...
        columns = [("City", 280), ("AQI", 60), ("Time", 200)]
